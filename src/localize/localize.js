...
export function get_language_endonym(language) {
...
export function get_iso_language_name(language) {
    return language_names[language][0][0];
  }
export function get_language_emoji(locale) {
...
export let language_to_default_region = {
  aa: "ET",
  ab: "GE",
  abr: "GH",
  ace: "ID",
