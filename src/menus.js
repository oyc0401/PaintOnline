...
const menus = {
	[localize("&File")]: [
		...
		// 		"set picture as wallpaper tiled",
		// 		"set drawing as wallpaper tiled",
		// 		"use as wallpaper tiled",
		// 		"use image as wallpaper tiled",
		// 		"use picture as wallpaper tiled",
		// 		"use drawing as wallpaper tiled",
		// 		"tile image as wallpaper",
		// 		"tile picture as wallpaper",
		// 		"tile drawing as wallpaper",
		// 	],
		// 	action: () => {
		// 		systemHooks.setWallpaperTiled(main_canvas);
		// 	},
		...
		// 		"set picture as wallpaper centered",
		// 		"set drawing as wallpaper centered",
		// 		"use as wallpaper centered",
		// 		"use image as wallpaper centered",
		// 		"use picture as wallpaper centered",
		// 		"use drawing as wallpaper centered",
		// 		"center image as wallpaper",
		// 		"center picture as wallpaper",
		// 		"center drawing as wallpaper",
		// 	],
		// 	action: () => {
		// 		systemHooks.setWallpaperCentered(main_canvas);
		// 	},
	...
	[localize("E&xtras")]: [
		...
		// 		"render history as gif",
		// 		"render history as a gif",
		// 		"render history animation",
		// 		"make history animation",
		// 		"make animation of history",
		// 		"make animation of document history",
		// 		"make animation from document history",
		// 		"render a gif from the history",
		// 		"render a gif animation from the history",
		// 		"render an animation from the history",
		// 		"make a gif from the history",
		// 		"make a gif animation from the history",
		// 		"make an animation from the history",
		// 		"create a gif from the history",
		// 		"create a gif animation from the history",
		// 		"create an animation from the history",
		// 		// aaaaaaaaaaaaaaaaaaaaaaaaaa *exponentially explodes*
		// 		"make a gif",
		// 		"make a gif of the history",
		// 		"make a gif of the document history",
		// 		"make a gif from the document history",
		// 		"create a gif",
		// 		"create a gif of the history",
		// 		"create a gif of the document history",
		// 		"create a gif from the document history",
		// 		"make gif",
		// 		"make gif of the history",
		// 		"make gif of the document history",
		// 		"make gif from the document history",
		// 		"create gif",
		// 		"create gif of the history",
		// 		"create gif of the document history",
		// 		"create gif from the document history",
		// 		"make an animation",
		// 		"make an animation of the history",
		// 		"make an animation of the document history",
		// 		"make an animation from the document history",
		// 		"create an animation",
		// 		"create an animation of the history",
		// 		"create an animation of the document history",
		// 		"create an animation from the document history",
		// 		"make animation",
		// 		"make animation of the history",
		// 		"make animation of the document history",
		// 		"make animation from the document history",
		// 		"create animation",
		// 		"create animation of the history",
		// 		"create animation of the document history",
		// 		"create animation from the document history",
		// 	],
		// 	action: () => {
		// 		render_history_as_gif();
		// 	},
			...
			submenu: [
				...
				},
				{
					...
					speech_recognition: [
						...
						"set theme winter",
						"switch to winter theme",
						"switch theme to winter",
						"switch theme winter",
						"holiday theme",
						"switch to holiday theme",
						"use holiday theme",
						"set theme to holiday",
						"set theme holiday",
						"switch to holiday theme",
						"switch theme to holiday",
						"switch theme holiday",
						"christmas theme",
						"switch to christmas theme",
						"use christmas theme",
						"set theme to christmas",
						"set theme christmas",
						"switch to christmas theme",
						"switch theme to christmas",
						"switch theme christmas",
						"hanukkah theme",
						"switch to hanukkah theme",
						"use hanukkah theme",
						"set theme to hanukkah",
						"set theme hanukkah",
						"switch to hanukkah theme",
						"switch theme to hanukkah",
						"switch theme hanukkah",
					],
					action: () => {
				...
				},
				{
					...
					speech_recognition: [
						"occult theme",
						"switch to occult theme",
						"use occult theme",
						"set theme to occult",
						"set theme occult",
						"switch to occult theme",
						"switch theme to occult",
						"switch theme occult",
						"occultist theme",
						"switch to occultist theme",
						"use occultist theme",
						"set theme to occultist",
						"set theme occultist",
						"switch to occultist theme",
						"switch theme to occultist",
						"switch theme occultist",
						"occultism theme",
						"switch to occultism theme",
						"use occultism theme",
						"set theme to occultism",
						"set theme occultism",
						"switch to occultism theme",
						"switch theme to occultism",
						"switch theme occultism",
						"satan theme",
						"switch to satan theme",
						"use satan theme",
						"set theme to satan",
						"set theme satan",
						"switch to satan theme",
						"switch theme to satan",
						"switch theme satan",
						"satanic theme",
						"switch to satanic theme",
						"use satanic theme",
						"set theme to satanic",
						"set theme satanic",
						"switch to satanic theme",
						"switch theme to satanic",
						"switch theme satanic",
						"satanist theme",
						"switch to satanist theme",
						"use satanist theme",
						"set theme to satanist",
						"set theme satanist",
						"switch to satanist theme",
						"switch theme to satanist",
						"switch theme satanist",
						"satanism theme",
						"switch to satanism theme",
						"use satanism theme",
						"set theme to satanism",
						"set theme satanism",
						"switch to satanism theme",
						"switch theme to satanism",
						"switch theme satanism",
						"demon theme",
						"switch to demon theme",
						"use demon theme",
						"set theme to demon",
						"set theme demon",
						"switch to demon theme",
						"switch theme to demon",
						"switch theme demon",
						"demonic theme",
						"switch to demonic theme",
						"use demonic theme",
						"set theme to demonic",
						"set theme demonic",
						"switch to demonic theme",
						"switch theme to demonic",
						"switch theme demonic",
						"daemon theme",
						"switch to daemon theme",
						"use daemon theme",
						"set theme to daemon",
						"set theme daemon",
						"switch to daemon theme",
						"switch theme to daemon",
						"switch theme daemon",
						"daemonic theme",
						"switch to daemonic theme",
						"use daemonic theme",
						"set theme to daemonic",
						"set theme daemonic",
						"switch to daemonic theme",
						"switch theme to daemonic",
						"switch theme daemonic",
						"devil theme",
						...
						"set theme devil",
						"switch to devil theme",
						"switch theme to devil",
						"switch theme devil",
						"devilish theme",
						"switch to devilish theme",
						"use devilish theme",
						"set theme to devilish",
						"set theme devilish",
						"switch to devilish theme",
						"switch theme to devilish",
						"switch theme devilish",
						"devil worship theme",
						"switch to devil worship theme",
						"use devil worship theme",
						"set theme to devil worship",
						"set theme devil worship",
						"switch to devil worship theme",
						"switch theme to devil worship",
						"switch theme devil worship",
						"witchcraft theme",
						"switch to witchcraft theme",
						"use witchcraft theme",
						"set theme to witchcraft",
						"set theme witchcraft",
						"switch to witchcraft theme",
						"switch theme to witchcraft",
						"switch theme witchcraft",
						"witch theme",
						"switch to witch theme",
						"use witch theme",
						"set theme to witch",
						"set theme witch",
						"switch to witch theme",
						"switch theme to witch",
						"switch theme witch",
						"witchy theme",
						"switch to witchy theme",
						"use witchy theme",
						"set theme to witchy",
						"set theme witchy",
						"switch to witchy theme",
						"switch theme to witchy",
						"switch theme witchy",
						"witchery theme",
						"switch to witchery theme",
						"use witchery theme",
						"set theme to witchery",
						"set theme witchery",
						"switch to witchery theme",
						"switch theme to witchery",
						"switch theme witchery",
						"ritual theme",
						"switch to ritual theme",
						"use ritual theme",
						"set theme to ritual",
						"set theme ritual",
						"switch to ritual theme",
						"switch theme to ritual",
						"switch theme ritual",
						"ritualism theme",
						"switch to ritualism theme",
						"use ritualism theme",
						"set theme to ritualism",
						"set theme ritualism",
						"switch to ritualism theme",
						"switch theme to ritualism",
						"switch theme ritualism",
						"ritualistic theme",
						"switch to ritualistic theme",
						"use ritualistic theme",
						"set theme to ritualistic",
						"set theme ritualistic",
						"switch to ritualistic theme",
						"switch theme to ritualistic",
						"switch theme ritualistic",
						"Halloween theme",
						"switch to Halloween theme",
						"use Halloween theme",
						"set theme to Halloween",
						"set theme Halloween",
						"switch to Halloween theme",
						"switch theme to Halloween",
						...
						"summon daemons",
						"summon demons theme",
						"summon daemons theme",
						"demon summoning",
						"daemon summoning",
						"demon summoning theme",
						"daemon summoning theme",
						"demons summoning",
						"daemons summoning",
						"demons summoning theme",
						"daemons summoning theme",
						"welcome demon",
						"welcome daemon",
						"welcome demon theme",
						"welcome daemon theme",
						"welcome demons",
						"welcome daemons",
						"welcome demons theme",
						"welcome daemons theme",
						"summon satan",
						"summon satan theme",
						"summon daemon theme",
						"satan summoning",
						"satan summoning theme",
						"daemon summoning theme",
						"welcome satan",
						"welcome satan theme",
						"summon devil",
						"summon the devil",
						"summon devil theme",
						"summon the devil theme",
						"welcome devil",
						"welcome the devil",
						"welcome devil theme",
						"welcome the devil theme",

						"I beseech thee",
						"I entreat thee",
						"I summon thee",
						"I call upon thy name",
						"I call upon thine name",
						"Lord Satan",
						"hail Satan",
						"hail Lord Satan",
						"O Mighty Satan",
				...
				},
				{
					...
					speech_recognition: [
						...
						"set theme bubblegum",
						"switch to bubblegum theme",
						"switch theme to bubblegum",
						"switch theme bubblegum",
						"pink theme",
					...
					description: localize(
						"Makes JS Paint look like pearlescent bubblegum.",
					),
				},
				// {
				// 	emoji_icon: "🪐",
		...
		// 	speech_recognition: [
		// 		"toggle vertical color box",
		// 		"toggle vertical color box mode",
		// 		"toggle vertical colors box",
		// 		"toggle vertical colors box mode",
		// 		"toggle vertical palette",
		// 		"toggle vertical palette mode",
		// 		"toggle horizontal color box",
		// 		"toggle horizontal color box mode",
		// 		"toggle horizontal colors box",
		// 		"toggle horizontal colors box mode",
		// 		"toggle horizontal palette",
		// 		"toggle horizontal palette mode",
		...
		},
		{
			...
			action: () => {
				window.open("https://github.com/1j01/jspaint");
			},
		...
		},
		{
			...
			speech_recognition: ["donate", "make a monetary contribution"],
			action: () => {
				window.open("https://www.paypal.me/IsaiahOdhner");
			},
